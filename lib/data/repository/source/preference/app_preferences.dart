...
class AppPreferences {
  ...
  bool get isDarkMode {
    return _sharedPreference.getBool(SharedPreferenceKeys.isDarkMode) ?? UiConstants.defaultDarkMode;
  }
  ...
  Future<bool> saveAccessToken(String token) async {
    final success = await _encryptedSharedPreferences.setString(SharedPreferenceKeys.accessToken, token);
    return success;
  }

  Future<bool> saveRefreshToken(String token) async {
    final success = await _encryptedSharedPreferences.setString(SharedPreferenceKeys.refreshToken, token);
    return success;
  }

  Future<bool> saveCurrentUser(PreferenceUserData preferenceUserData) {
    return _sharedPreference.setString(SharedPreferenceKeys.currentUser, json.encode(preferenceUserData));
  }
